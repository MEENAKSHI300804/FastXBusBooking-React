...
import { LogOut, LayoutDashboard, Users, UserCog, Ticket, Menu, User } from "lucide-react";
      ...
      <aside className="w-64 bg-slate-900 text-slate-100 border-r border-slate-800 hidden md:flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-slate-800">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-tight">FastX Admin</span>
          </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b bg-white flex items-center justify-between px-4 sm:px-6 shadow-sm z-10">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-semibold text-lg hidden sm:block">Admin Console</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/" className="cursor-pointer">Passenger View</Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
